...
<script type="text/javascript">
    ...
    function Edit(id) {
        var url = id ? Qk.getRealRoutePath('{{ route_uri('admin.config.ad.edit') }}', {ad: id}) : '{{ route('admin.config.ad.create') }}';
    ...
    function Save(id, form_datas) {
        var saveUrl = id > 0 ? Qk.getRealRoutePath('{{ route_uri('admin.config.ad.update') }}', {ad: id}) : '{{ route('admin.config.ad.store') }}';
    ...
    function Delete(id) {
        var confirm_dialog = Qk.confirm({
            ...
            yes: function () {
                ...
                Qk.ajaxRequest(Qk.getRealRoutePath('{{ route_uri('admin.config.ad.destroy') }}', {ad: id}), null, 'DELETE', function (data) {
                    if (data.status == 'success') {
    ...
    layui.use('form', function () {
        ...
        layui.form.on('checkbox(ad_publish)', function (obj) {
            var url = Qk.getRealRoutePath('{{ route_uri('admin.config.ad.update_publish_date') }}', {ad: this.value});
